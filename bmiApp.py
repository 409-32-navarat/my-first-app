...
#ส่วนที่2 สร้างช่องรับค่าน้ำหนัก และ ส่วนสูง (ปรับค่าเริ่มต้นให้สมจริงเพื่อป้องการเอเรอร์ตอนคำนวณครั้งแรก)
...
if st.button("คำนวณค่า BMI 💡"):
    ...
    #ส่วนที่ 4 แปลผลค่า BMI ตามเกณฑ์ (จัดแนวเยื้องตรงตามโครงสร้าง Python ถูกต้อง 100%)
    if bmi < 18.5:
